...
<body>
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
            <h2 class="font-bold text-2xl">ADMIN <span class="bg-[#f84525] text-white px-2 rounded-md">DASHBOARD</span></h2>
        </a>
        <ul class="mt-4">
            <span class="text-gray-400 font-bold">ADMIN</span>
            <li class="mb-1 group">
                <a href="{{ route('dashboard') }}"
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-900 hover:text-gray-100 rounded-md 
            ...
            <li class="mb-1 group">
                <a href=""
                    class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-900 hover:text-gray-100 rounded-md sidebar-dropdown-toggle
                    {{ request()->is('users*') ? 'bg-gray-800 text-white' : '' }}">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    ...
                    <li class="mb-4">
                        <a href=""
                            class="text-gray-900 text-sm flex items-center hover:text-[#f84525] 
                            {{ request()->is('users/roles') ? 'text-[#f84525]' : '' }}">
                            Tambah
                        </a>
                    </li>
                </ul>
            ...
            <li class="mb-1 group">
                <a href="{{ route('profile.edit') }}"
                    ...
                    {{ request()->is('profile') ? 'bg-gray-800 text-white' : '' }}">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <div class="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            <button type="button" class="flex lg:hidden text-lg text-gray-900 font-semibold sidebar-toggle">
